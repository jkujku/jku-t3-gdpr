...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:jku_gdpr/Resources/Private/Language/locallang_db.xlf:tx_jkugdpr_domain_model_categorytom',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_jkugdpr_domain_model_categorytom}.{#pid}=###CURRENT_PID### AND {#tx_jkugdpr_domain_model_categorytom}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'title' => [
            'exclude' => false,
            'label' => 'LLL:EXT:jku_gdpr/Resources/Private/Language/locallang_db.xlf:tx_jkugdpr_domain_model_categorytom.title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
        ...
        'description' => [
            'exclude' => false,
            'label' => 'LLL:EXT:jku_gdpr/Resources/Private/Language/locallang_db.xlf:tx_jkugdpr_domain_model_categorytom.description',
            'config' => [
                'type' => 'text',
                'cols' => 40,
                'rows' => 15,
